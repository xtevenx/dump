"""
Requires the file https://users.cecs.anu.edu.au/~bdm/data/tourn5.txt to be
placed in the current directory. It contains all tournaments on 5 vertices,
